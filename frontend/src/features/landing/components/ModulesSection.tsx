const tiles = [
  {
    ...
    art: (
      ...
      <svg viewBox="0 0 800 520" aria-hidden="true" className="h-full w-full">
        <rect width="800" height="520" fill="var(--green-900)" />
        ...
        <text x="84" y="180" fill="var(--green-075)" fontFamily="Inter, sans-serif" fontWeight="700" fontSize="20">Site A</text>
        {/* Location pin dot */}
        <circle cx="68" cy="174" r="5" fill="var(--green-300)" />
        {/* Track background */}
        ...
        <text x="84" y="266" fill="var(--green-075)" fontFamily="Inter, sans-serif" fontWeight="700" fontSize="20">Site B</text>
        <circle cx="68" cy="260" r="5" fill="var(--green-300)" />
        ...
        <text x="84" y="352" fill="var(--green-075)" fontFamily="Inter, sans-serif" fontWeight="700" fontSize="20">Site C</text>
        <circle cx="68" cy="346" r="5" fill="var(--green-300)" />
  ...
  },
  {
    ...
    art: (
      <svg viewBox="0 0 400 260" aria-hidden="true" className="h-full w-full">
        <rect width="400" height="260" fill="var(--green-600)" />
  ...
  },
  {
    ...
    art: (
      <svg viewBox="0 0 400 260" aria-hidden="true" className="h-full w-full">
        <rect width="400" height="260" fill="var(--green-300)" />
        <polyline
  ...
  },
  {
    ...
    art: (
      <svg viewBox="0 0 400 260" aria-hidden="true" className="h-full w-full">
        <rect width="400" height="260" fill="var(--green-950)" />
        <rect x="60" y="60" width="280" height="140" rx="10" fill="#2f4a29" />
        <circle cx="110" cy="130" r="8" fill="var(--green-075)" />
    ...
    <section id="features" className="py-14 md:py-20">
      <div className="mx-auto w-full px-6" style={{ maxWidth: "var(--maxw)" }}>
        ...
        <div className="mb-10 flex flex-wrap items-end justify-between gap-8">
          ...
          <a
            href="#stack"
            className="inline-flex items-center rounded-full px-5 py-2.5 text-sm font-semibold text-ink-on-brand transition-opacity hover:opacity-85"
        ...
        >
          {tiles.map((tile) => (
            ...
            >
              ...
              >
                <h3 className="mb-1 text-base font-bold text-ink-on-brand">{tile.title}</h3>
